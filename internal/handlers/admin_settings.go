	...
	defaults := map[string]interface{}{
		...
		"marketplace": map[string]interface{}{
			...
			"packs": []map[string]interface{}{
				{"name": "go-backend", "display_name": "Go Backend", "desc": "Fiber v3, GORM, JWT, asynq, gocron, stripe-go, zerolog, go-mail, validator. Full Go API development patterns.", "skills": 12, "agents": 3, "hooks": 2, "color": "#00acd7", "tags": []string{"go", "api", "backend"}, "stacks": []string{"go"}},
				{"name": "rust-engine", "display_name": "Rust Engine", "desc": "Tonic gRPC, Tree-sitter, Tantivy, rusqlite, tower-lsp, ropey, dashmap, ring. Rust plugin development.", "skills": 10, "agents": 2, "hooks": 1, "color": "#f74c00", "tags": []string{"rust", "grpc", "search"}, "stacks": []string{"rust"}},
				{"name": "typescript-react", "display_name": "TypeScript + React", "desc": "React, Zustand, React Query, Vite, shadcn/ui, Tailwind CSS v4, Monaco, xterm.js. Modern frontend patterns.", "skills": 14, "agents": 4, "hooks": 3, "color": "#3178c6", "tags": []string{"react", "typescript", "frontend"}, "stacks": []string{"react", "typescript"}},
				{"name": "database-sync", "display_name": "Database & Sync", "desc": "PostgreSQL, pgvector, SQLite, Redis, sync protocol, migrations, conflict resolution.", "skills": 8, "agents": 2, "hooks": 1, "color": "#336791", "tags": []string{"postgres", "sqlite", "redis", "sync"}, "stacks": []string{"*"}},
				{"name": "ai-agentic", "display_name": "AI & Agentic", "desc": "Anthropic SDK, OpenAI, langchaingo, chromem-go, pgvector, RAG, vector search, embeddings, tool use.", "skills": 16, "agents": 6, "hooks": 2, "color": "#a900ff", "tags": []string{"ai", "llm", "rag", "agents"}, "stacks": []string{"*"}},
				{"name": "chrome-extension", "display_name": "Chrome Extension", "desc": "Manifest V3, service worker, content scripts, side panel, Chrome APIs.", "skills": 7, "agents": 1, "hooks": 2, "color": "#4285f4", "tags": []string{"chrome", "extension", "browser"}, "stacks": []string{"typescript"}},
				{"name": "macos-integration", "display_name": "macOS Integration", "desc": "CGo, Spotlight, Keychain, iCloud, Touch Bar, Notifications, file associations, URL schemes.", "skills": 9, "agents": 2, "hooks": 1, "color": "#888", "tags": []string{"macos", "swift", "cgo"}, "stacks": []string{"swift", "go"}},
				{"name": "gcp-infrastructure", "display_name": "GCP Infrastructure", "desc": "Cloud Run, Cloud SQL, CDN, Cloud Build, Artifact Registry, Secret Manager, Docker, nginx, Sentry, PostHog.", "skills": 11, "agents": 3, "hooks": 4, "color": "#4285f4", "tags": []string{"gcp", "docker", "devops"}, "stacks": []string{"docker", "go", "typescript"}},
				{"name": "proto-grpc", "display_name": "Proto + gRPC", "desc": "Protobuf, Buf, tonic-build, Go/Rust code generation, service contracts.", "skills": 6, "agents": 1, "hooks": 1, "color": "#00e5ff", "tags": []string{"protobuf", "grpc", "codegen"}, "stacks": []string{"go", "rust"}},
				{"name": "wails-desktop", "display_name": "Wails Desktop", "desc": "Wails v3, Go-React bindings, system tray, window management, native desktop features.", "skills": 8, "agents": 2, "hooks": 1, "color": "#22c55e", "tags": []string{"wails", "desktop", "go"}, "stacks": []string{"go"}},
				{"name": "react-native-mobile", "display_name": "React Native Mobile", "desc": "React Native, WatermelonDB, React Navigation, offline sync, iOS/Android native code.", "skills": 9, "agents": 2, "hooks": 2, "color": "#61dafb", "tags": []string{"mobile", "react-native", "ios", "android"}, "stacks": []string{"react-native"}},
				{"name": "native-extensions", "display_name": "Native Extensions", "desc": "Extension lifecycle, commands, editor API, AI API, filesystem, UI, permissions, sandbox.", "skills": 10, "agents": 2, "hooks": 2, "color": "#f97316", "tags": []string{"extensions", "plugins", "sdk"}, "stacks": []string{"*"}},
				{"name": "native-widgets", "display_name": "Native Widgets", "desc": "macOS WidgetKit, Windows Adaptive Cards, Linux GNOME/KDE. Cross-platform OS widget system.", "skills": 7, "agents": 1, "hooks": 1, "color": "#ec4899", "tags": []string{"widgets", "macos", "windows", "linux"}, "stacks": []string{"swift", "csharp", "c"}},
				{"name": "vscode-compat", "display_name": "VS Code Compat", "desc": "LSP/DAP, theme migration, snippets, grammars. Run VS Code extensions in Orchestra (~85% compat).", "skills": 8, "agents": 2, "hooks": 1, "color": "#007acc", "tags": []string{"vscode", "lsp", "dap"}, "stacks": []string{"typescript"}},
				{"name": "raycast-compat", "display_name": "Raycast Compat", "desc": "List/Detail/Form/Action components. Run Raycast extensions in Orchestra (~95% compat).", "skills": 6, "agents": 1, "hooks": 1, "color": "#ff6363", "tags": []string{"raycast", "extensions"}, "stacks": []string{"typescript"}},
				{"name": "extension-marketplace", "display_name": "Extension Marketplace", "desc": "Publishing, search, CLI, versioning, reviews, auto-updates. Full extension store pipeline.", "skills": 8, "agents": 2, "hooks": 2, "color": "#a855f7", "tags": []string{"marketplace", "publishing"}, "stacks": []string{"*"}},
				{"name": "project-manager", "display_name": "Project Manager", "desc": "Sprint planning, feature breakdown, ADRs, cross-team coordination. Scrum + cyclical delivery.", "skills": 10, "agents": 3, "hooks": 2, "color": "#eab308", "tags": []string{"scrum", "agile", "pm"}, "stacks": []string{"*"}},
			},
		},
		"plugins": map[string]interface{}{
			...
			"plugins": []map[string]interface{}{
				...
				{"name": "bridge-claude", "display_name": "Claude Bridge", "desc": "Anthropic Claude integration with streaming support.", "tools": 6, "language": "Go", "repo": "orchestra-mcp/plugin-bridge-claude", "color": "#d97757"},
